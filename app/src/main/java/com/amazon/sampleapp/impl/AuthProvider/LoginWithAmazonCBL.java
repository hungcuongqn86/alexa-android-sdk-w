...
import com.amazon.aace.AuthProvider;
import com.amazon.aace.NetworkInfoProvider;
...
public class LoginWithAmazonCBL implements AuthHandler, NetworkConnectionObserver {
        ...
        public void run() {
            try {
                if (!Pattern.matches(sDefaultRegExpr, mClientId)) {
                    ...
                    mLogger.postWarn(sTag, "Cannot authenticate. Please review the configuration file in the app's assets directory.");
    ...
    private class refreshAuthTokenTask implements Runnable {
        ...
        refreshAuthTokenTask(String refreshToken) {

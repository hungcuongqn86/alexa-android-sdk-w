...
package com.amazon.aace;

import com.amazon.aace.PlatformInterface;
...
abstract public class ContactUploader extends PlatformInterface
{
    ...
    final public boolean addContactsBegin() {
        return addContactsBegin(getNativeRef());
    }
    ...
    final public boolean addContactsEnd() {
        return addContactsEnd(getNativeRef());
    }
    ...
    final public boolean addContactsCancel() {
        return addContactsCancel( getNativeRef() );
    }
    ...
    final public boolean addContact( String contact ) {
        return addContact( getNativeRef(), contact );
    }
    ...
    final public boolean removeUploadedContacts() {
        return removeUploadedContacts( getNativeRef() );
    }
    ...
    private native boolean addContactsBegin( long nativeRef );
    private native boolean addContactsEnd( long nativeRef );
    private native boolean addContactsCancel( long nativeRef );
    private native boolean addContact( long nativeRef, String contact );
    private native boolean removeUploadedContacts( long nativeRef );
}
